!(function (t, e) {
			...
			attr: function (t, e, i) {
				...
				for (r = (s = t.attributes).length; r--; )
					(n = s[r]) &&
						n.specified &&
						a.test(n.name) &&
						(i[this.camelize(n.name.slice(e.length))] =
	...
	r.prototype = {
		...
		_pipeAccordingToValidationResult: function () {
			function t() {
				var t = h.Deferred();
				return (
					!0 !== e.validationResult && t.reject(), t.resolve().promise()
				);
			}
			var e = this;
			return [t, t];
	...
	function m(s, a) {
		return function (t) {
			...
			return (
				i.pop(),
				a.apply(void 0, [t].concat(u(((n = s), i.map(d.parse[n])))))
			);
			var n;
		};
	}
	...
	a.prototype = {
		...
		removeValidator: function (t) {
			return (
				this.validators[t] ||
					d.warn('Validator "' + t + '" is not defined.'),
		...
		validators: {
			...
			type: {
				validateString: function (t, e, i) {
					...
					if (!l)
						throw new Error(
							"validator type `" + e + "` is not supported"
						);
					if (!t) return !0;
	...
	y.prototype = {
		onSubmitValidate: function (t) {
			...
			if (!0 !== t.parsley) {
				var i =
					this._submitSource || this.$element.find(d._SubmitSelector)[0];
				if (
