									...
									if (
										...
										try {
											for (
												...
												(l = d.value).innerHTML = this.filesize(
													t.size
												);
										} catch (e) {
											(u = !0), (c = e);
				...
				[
					...
					},
					{
						...
						value: function () {
							return this.files
								.filter(function (e) {
									return (
										e.status === C.UPLOADING || e.status === C.QUEUED
									);
								})
								.map(function (e) {
									return e;
							...
							if (
								...
								!(function l() {
									return (
										...
										(null === s.options.maxFiles ||
											1 < s.options.maxFiles) &&
										...
										s.hiddenFileInput.addEventListener(
											"change",
											function () {
						...
						value: function () {
							...
							if (this.getActiveFiles().length) {
								...
								try {
									for (
										var a,
											l = this.getActiveFiles()[Symbol.iterator]();
										!(i = (a = l.next()).done);
										i = !0
									) {
										var s = a.value;
						...
						value: function (e) {
							...
							if (0 < e) {
								for (
									...
									var o = i[r];
									if (
										Math.pow(this.options.filesizeBase, 4 - r) / 10 <=
										e
									) {
										(t =
											e /
							...
							return (function () {
								...
								try {
									for (
										...
										var a,
											l = r.value;
										null != l.webkitGetAsEntry &&
										(a = l.webkitGetAsEntry())
											? a.isFile
												? e.push(u.addFile(l.getAsFile()))
												: a.isDirectory
												? e.push(
														u._addFilesFromDirectory(a, a.name)
												  )
												: e.push(void 0)
											: null != l.getAsFile &&
					...
					},
					{
						...
						value: function (t, e, n, i, r) {
							...
							if (
								(this.emit("addedfile", t), this.emit("complete", t), a)
							) {
								(t.dataURL = e),
										...
										((r.upload.finishedChunkUpload = function (e) {
											...
											for (
												...
												if (void 0 === r.upload.chunks[n])
													return i();
												r.upload.chunks[n].status !== C.SUCCESS &&
													(t = !1);
											}
											t &&
