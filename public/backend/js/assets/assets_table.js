$(document).ready(function() {  
    ...
    var url = $('#get-assets').data('url');
    $('.table').DataTable({
        dom: '<"row position-relative  position-relative margin-bottom-20 text-center"<"export-row text-left"lBPfr>tip',  
        //filter
        processing: false,
        serverSide: true,
        ajax: {
        ...
        searching: true, 
        info:true,
        language: { search: "",searchPlaceholder: "Search..." ,emptyTable:function(){ 
