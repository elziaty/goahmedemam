$(document).ready(function() {  
    var url = $('#get-all-applied-leave').data('url');
    $('.table.all-applied-leave').DataTable({
...
//pending applied leave  
    var pendingurl = $('#get-pending-applied-leave').data('url');
    $('.table.pending-applied-leave').DataTable({
        dom: '<"row position-relative  margin-bottom-20 text-center"<"export-row text-left"lBPfr>tip',  
        //filter
        processing: false,
        serverSide: true,
...
//approved applied leave 
    var approvedurl = $('#get-approved-applied-leave').data('url');
    $('.table.approved-applied-leave').DataTable({
        dom: '<"row position-relative  margin-bottom-20 text-center"<"export-row text-left"lBPfr>tip',  
        //filter
        processing: false,
        serverSide: true,
    ...
    //rejected applied leave 
    var rejectedurl = $('#get-rejected-applied-leave').data('url');
    $('.table.rejected-applied-leave').DataTable({
        dom: '<"row position-relative  margin-bottom-20 text-center"<"export-row text-left"lBPfr>tip',  
        //filter
        processing: false,
        serverSide: true,
