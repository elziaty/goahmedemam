$(document).ready(function(){
    ...
    $('#product_find').autocomplete({
        ...
        source: function(request,add){//source 
            var products =[];
            const ids = $('input[name="service_unique_add[]"]').map(function () {
                return this.value;  
            }).get(); 
            $.ajax({
                ...
                success: (response) => {  
                    if(response.single){
                        ...
                        if(ids.includes(response.id.toString()) == true){ 
                            ...
                            //end sound effect  
                            toastr.error( 'Service Already added.','Error');  
                        ...
                        if(response.length <=0){
                            ...
                            //end sound effect  
                            toastr.error( 'Service was not found.','Error'); 
                        }
                        // products = response;
