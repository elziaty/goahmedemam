                        ...
                        <form action="{{ route('role.update',['id'=>$role->id]) }}" method="post">
                            ...
                            <div class="row mt-3">
                                <div class="col-lg-4">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <input type="text" name="name" class="form-control form--control" id="name" value="{{ old('name',$role->name) }}">
                                            @error('name')
                                        ...
                                        <div class="col-sm-12 pt-25">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <input type="checkbox" class="status" id="status" switch="success" name="status" {{ $role->status == App\Enums\Status::ACTIVE ? 'checked':'' }}>
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="table-responsive   role-permissions">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12 col-sm-6 col-md-4">
                                                                    <div class="row align-items-center permission-check-box pb-2 pt-2"  >
                                                                        <input id="{{ $keyword }}" class="read common-key" type="checkbox" value="{{ $keyword }}" name="permissions[]" @if(in_array($keyword,$role->permissions)) checked @endif />
                                ...
                                <div class="col-md-12 mt-5 text-end">
                                    <button type="submit" class="btn-sm submit-btn btn-primary btn-lg"><i class="fa fa-save"></i> {{__('update')}}</button>
                                </div>
                            </div>
                        </form>
