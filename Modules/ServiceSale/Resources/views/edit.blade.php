            ...
            <div class="row g-4">
                <div class="col-xl-12">
                    <div class="dashboard--widget ">
                        ...
                        <form action="{{ route('servicesale.update',['id'=>$sale->id]) }}" method="post" enctype="multipart/form-data">
                            @csrf 
                            @method('put')
                            <div class="row mt-3">   
                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody id="sale_item_body"> 
                                                ...
                                                @foreach ($sale->saleItems as $item)
                                                    @include('servicesale::service_item_edit')
                                                @endforeach
                                            </tbody>
                                            <thead>
                                                <tr class="border-bottom bg-primary text-white head align-middle ">
...
@endsection
@push('scripts')
    <script src="{{ static_asset('backend') }}/js/servicesale/create.js"></script> 
@endpush