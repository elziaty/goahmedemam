                        ...
                        <div id="sale_print"> 
                            <div class="row"> 
                                <div class="col-12 mt-5"> 
                                    ...
                                    <div class="text-center"><small>( {{ __('service_sale') }} )</small></div>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <b>{{ __('sub_total') }}</b>
                                        <span>{{ businessCurrency($sale->business_id) }}  {{ number_format($sale->total_price,2) }}</span>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                        <b>{{ __('order_tax') }}</b>
