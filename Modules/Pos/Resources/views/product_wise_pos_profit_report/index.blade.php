...
@section('title',__('product_wise_pos_profit'))
@section('breadcrumb')
    <div class="breadcrumb-area">
        <h5 class="title text--base m-0">{{ __('reports') }}</h5>
        <ul class="breadcrumb">
            <li > <a href="#"> {{ __('reports') }}</a> </li> 
            <li class="active">  {{ __('product_wise_pos_profit') }} </li>
        </ul>
    </div>
@endsection
            ...
            <div class="row g-4">
                <div class="col-xl-12">
                    <div class="dashboard--widget ">  
                        <form action="{{ route('reports.product.wise.pos.profit.get') }}" method="get">
                            @method('get')
                ...
                <div class="col-lg-12">
                    <div class="dashboard--widget  " id="printsection">  
                        <div class="row mb-3">  
                            ...
                            <p class="overflow-hidden text-center my-2" > <b>{{__('product_wise_pos_profit') }} {{ __('reports') }}</b></p> 
                                ...
                                <tbody>
                                    ...
                                    @foreach ($products as $key=>$product) 
                                        <tr>
                                            ...
                                            <td data-title="{{ __('gross_profit') }}">
                                                {{ businessCurrency(business_id()) }} {{ number_format(productTotalPosPrice($product) -  productTotalPurchaseCost($product,$request->date),2)  }}
                                            </td> 
                                        </tr>
                                    @endforeach
                                </tbody>
