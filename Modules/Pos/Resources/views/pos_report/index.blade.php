                ...
                <div class="col-lg-12">
                    <div class="dashboard--widget  " id="printsection">  
                        <div class="row mb-3">  
                            ...
                            <p class="overflow-hidden text-center my-2" > <b>{{__('pos_report') }} </b></p>
                        </div>
                        <div id="pos_report_content" data-url="{{ route('reports.pos.report.get.report') }}" > 
                        </div>
                    </div>
                </div> 
            </div>
...
@push('scripts')
    ...
    <script src="{{static_asset('backend')}}/js/pos/pos_report/pos_report.js"></script> 
    <script src="{{static_asset('backend')}}/js/pos/pos_report/pos_report_print.js"></script> 
@endpush
