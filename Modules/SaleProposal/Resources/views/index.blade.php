...
@section('maincontent') 
                ...
                <div class="col-xl-12">
                    <div class="dashboard--widget ">
                        <h4 class="card-title overflow-hidden"> 
                            @if(hasPermission('sale_proposal_create'))
                                <a  href="{{ route('saleproposal.create') }}" class="btn btn-primary float-right  "  data-bs-toggle="tooltip" title="{{ __('levels.add') }}"
    ...
    <input type="hidden" id="get-saleproposal-list" data-url="{{ route('saleproposal.get.all') }}"/>
@endsection
@push('scripts') 
<script src="{{ static_asset('backend') }}/js/bootstrap.bundle2.min.js" ></script>  
<script src="{{ static_asset('backend') }}/js/saleproposal/saleproposal_table.js" ></script>  
@endpush
