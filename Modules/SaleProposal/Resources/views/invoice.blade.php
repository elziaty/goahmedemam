...
@section('title',__('proposal_invoice_view'))
                        ...
                        <div class="row print-row">
                            <div class="col-12 text-right mt-2">
                                <div class="d-inline-block">
                                    <button type="button" class="btn btn-sm btn-primary text-white" onclick="printOnlyDiv('proposal_print')">{{ __('print') }}</button> 
                                </div>
                            </div>
                        </div>
                        <div id="proposal_print"> 
                            <div class="row"> 
                                <div class="col-12 mt-5"> 
                                    ...
                                    <div class="text-center"><small>( {{ __('sale_proposal') }} )</small></div>
