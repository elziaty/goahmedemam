            ...
            <div class="row g-4">
                <div class="col-xl-12">
                    <div class="dashboard--widget ">
                        ...
                        <form action="{{ route('saleproposal.store') }}" method="post" enctype="multipart/form-data">
                            @csrf 
                            <div class="row mt-3">   
                                            ...
                                            <tbody id="sale_item_body"> 
                                                @if (old('variation_locations'))
                                                   @foreach (old('variation_locations') as $variation_location) 
                                                        @include('saleproposal::variation_location_item_old',['item'=>$variation_location])
                                                   @endforeach
                                                @endif
...
<script src="{{ static_asset('backend') }}/js/saleproposal/create.js"></script>  
    @if(old())
        <script src="{{ static_asset('backend') }}/js/saleproposal/create-old-value.js"></script>  
    @endif
@endpush