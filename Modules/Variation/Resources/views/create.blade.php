    ...
    <div class="row"> 
        @if(isSuperadmin())
            <div class="col-6 mt-3">
                ...
                <select class=" form-control form--control select2" name="business_id" required id="business_id" data-url="{{ route('category.parent.categories') }}">
        ...
        <div class="col-lg-12 mt-3 options">
            ...
            <div class="d-flex mt-3">
                <input type="text" name="values[]" class="form-control form--control"  id="values" value="{{ old('values') }}"> 
