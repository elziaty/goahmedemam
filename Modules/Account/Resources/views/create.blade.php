            ...
            <div class="row g-4">
                <div class="col-xl-12">
                    <div class="dashboard--widget "> 
                        ...
                        <form action="{{ route('accounts.account.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row mt-3">
                                ...
                                <div class="col-lg-6 mt-2">
                                    ...
                                    <select class="form-control form--control select2" name="payment_gateway" id="payment_gateway"> 
                                        @foreach (\Config::get('pos_default.payment_gatway') as $key=>$gateway)
                                            <option value="{{ $key }}" @if(old('payment_gateway',1) == $key) selected @endif>{{ __($gateway) }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-lg-6 mt-3 bank @if(old('payment_gateway') == \Modules\Account\Enums\PaymentGateway::BANK) d-block @else d-none @endif">
                                    <label for="bank_name" class="form-label">{{ __('bank_name') }} <span class="text-danger">*</span></label>
                                    <input type="text" name="bank_name" class="form-control form--control" id="bank_name" value="{{ old('bank_name') }}">
                                    @error('bank_name')
                                        <p class="text-danger pt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="col-sm-6 mt-2 both @if(old('payment_gateway') == \Modules\Account\Enums\PaymentGateway::BANK || old('payment_gateway') == \Modules\Account\Enums\PaymentGateway::MOBILE) d-block @else d-none @endif">
                                    <label for="holder_name" class="form-label">{{ __('holder_name') }} <span class="text-danger">*</span></label>
                                    <input type="text" name="holder_name" class="form-control form--control" id="holder_name" value="{{ old('holder_name') }}">
                                    @error('holder_name')
                                        <p class="text-danger pt-2">{{ $message }}</p>
                                    @enderror
                                </div>

                                <div class="col-sm-6 mt-2 bank @if(old('payment_gateway') == \Modules\Account\Enums\PaymentGateway::BANK) d-block @else d-none @endif">
                                    <label for="account_no" class="form-label">{{ __('account_no') }} <span class="text-danger">*</span></label>
                                    <input type="text" name="account_no" class="form-control form--control" id="account_no" value="{{ old('account_no') }}">
                                    @error('account_no')
                                        <p class="text-danger pt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mt-2 mobile @if(old('payment_gateway') == \Modules\Account\Enums\PaymentGateway::MOBILE) d-block @else d-none @endif">
                                    <label for="mobile" class="form-label">{{ __('mobile') }} <span class="text-danger">*</span></label>
                                    <input type="text" name="mobile" class="form-control form--control" id="mobile" value="{{ old('mobile') }}">
                                    @error('mobile')
                                        <p class="text-danger pt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mt-2 mobile @if(old('payment_gateway') == \Modules\Account\Enums\PaymentGateway::MOBILE) d-block @else d-none @endif">
                                    ...
                                    <input type="text" name="number_type" class="form-control form--control" id="number_type" value="{{ old('number_type') }}">
                                    @error('number_type')
                                        <p class="text-danger pt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mt-2">
                                    ...
                                    <input type="text" name="balance" class="form-control form--control" id="balance" value="{{ old('balance',0) }}">
                                    @error('balance')
                                        <p class="text-danger pt-2">{{ $message }}</p>
                                    @enderror
                                </div>
...
@endsection
@push('scripts')
    <script src="{{ static_asset('backend') }}/js/account/create.js" ></script>  
@endpush