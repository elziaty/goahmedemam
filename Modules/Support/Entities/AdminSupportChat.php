...
class AdminSupportChat extends Model
{
    use HasFactory;
    ...
    public function support(){
        return $this->belongsTo(AdminSupport::class,'support_id','id');
    }
    ...
    public function getUserTypeAttribute(){
        if($this->user->user_type == UserType::SUPERADMIN):
            $user_type  = __('admin');
        else:
            $user_type  = __('business');
        endif;
        return $user_type;
    }
