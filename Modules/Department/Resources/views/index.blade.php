...
@section('maincontent')
                    ...
                    <div class="dashboard--widget ">
                        <h4 class="card-title overflow-hidden"> 
                            @if(hasPermission('department_create'))
                                <a href="{{ route('hrm.department.create') }}" class="btn btn-primary float-right" data-bs-toggle="tooltip" title="{{ __('levels.add') }}"
    ...
    <input type="hidden"  id="get-departments" data-url="{{ route('hrm.department.get.all') }}" />
@endsection
@push('scripts') 
    <script src="{{ static_asset('backend') }}/js/bootstrap.bundle2.min.js" ></script>
    <script src="{{ static_asset('backend') }}/js/hrm/department_table.js" ></script>
@endpush
