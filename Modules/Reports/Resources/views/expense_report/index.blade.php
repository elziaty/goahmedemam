...
@section('breadcrumb')
    <div class="breadcrumb-area">
        ...
        <ul class="breadcrumb">
            ...
            <li class="active">  {{ __('expense_report') }} </li>
        </ul>
    </div>
@endsection
                ...
                <div class="col-lg-12">
                    <div class="dashboard--widget  " id="printsection">  
                        <div class="row mb-3">  
                            ...
                            <p class="overflow-hidden text-center my-2" > <b>{{__('expense_report') }} </b></p>
                        </div>
                        <div id="expense_report_content" data-url="{{ route('reports.expense.report.get.report') }}" > 
                        </div>
                    </div>
                </div> 
            </div>
...
@push('scripts')
    ...
    @endif 
    <script src="{{static_asset('backend')}}/js/reports/expense_report.js"></script> 
    <script src="{{static_asset('backend')}}/js/reports/expense_report_print.js"></script> 
