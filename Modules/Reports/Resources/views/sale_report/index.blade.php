                ...
                <div class="col-lg-12">
                    <div class="dashboard--widget  " id="printsection">  
                        <div class="row mb-3">  
                            ...
                            <p class="overflow-hidden text-center my-2" > <b>{{__('sale_report') }} </b></p>
                        </div>
                        <div id="sale_report_content" data-url="{{ route('reports.sale.report.get.report') }}" > 
                        </div>
                    </div>
                </div> 
            </div>
...
@push('scripts')
    ...
    <script src="{{static_asset('backend')}}/js/reports/sale_report/sale_report.js"></script> 
    <script src="{{static_asset('backend')}}/js/reports/sale_report/sale_report_print.js"></script> 
@endpush
