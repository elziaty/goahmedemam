...
@section('title',__('purchase_return_report'))
@section('breadcrumb')
    <div class="breadcrumb-area">
        <h5 class="title text--base m-0">{{ __('reports') }}</h5>
        <ul class="breadcrumb">
            <li > <a href="#"> {{ __('reports') }}</a> </li> 
            <li class="active">  {{ __('purchase_return_report') }} </li>
        </ul>
    </div>
@endsection
                ...
                <div class="col-lg-12">
                    <div class="dashboard--widget  " id="printsection">  
                        <div class="row mb-3">  
                            ...
                            <p class="overflow-hidden text-center my-2" > <b>{{__('purchase_return_report') }} </b></p>
                        </div>
                        <div id="purchase_return_report_content" data-url="{{ route('reports.purchase.return.report.get.report') }}" > 
                        </div>
                    </div>
                </div> 
            </div>
...
@push('scripts')
    ...
    <script src="{{static_asset('backend')}}/js/reports/purchase_return_report/purchase_return_report.js"></script> 
    <script src="{{static_asset('backend')}}/js/reports/purchase_return_report/purchase_return_report_print.js"></script> 
@endpush
