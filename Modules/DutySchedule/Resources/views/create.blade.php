            ...
            <div class="row g-4">
                <div class="col-xl-12">
                    <div class="dashboard--widget ">
                        ...
                        <form action="{{ route('hrm.attendance.duty.schedule.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row mt-3">
                                ...
                                <div class="col-lg-6  mt-3">
                                    ...
                                    <input type="time"  name="start_time" class="form-control form--control time" id="start_time" value="{{ old('start_time') }}">
                                    @error('start_time')
                                        <p class="text-danger pt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="col-lg-6  mt-3">
                                    ...
                                    <input type="time"  name="end_time" class="form-control form--control" id="end_time" value="{{ old('end_time') }}">
                                    @error('end_time')
                                        <p class="text-danger pt-2">{{ $message }}</p>
                                    @enderror
                                </div>
