            ...
            <div class="row g-4">
                <div class="col-xl-12">
                    <div class="dashboard--widget ">
                        ...
                        <form action="{{ route('settings.currency.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row mt-3">

                                <div class="col-lg-6 mt-3">
                                    <label for="country" class="form-label">{{ __('country') }} <span class="text-danger">*</span></label>
                                    <input type="text" name="country" class="form-control form--control" id="country" value="{{ old('country') }}">
                                    @error('country')
                                ...
                                <div class="col-lg-6 mt-3">
                                    ...
                                    <input type="text" name="currency" class="form-control form--control" id="currency" value="{{ old('currency') }}">
                                    @error('currency')
                                        <p class="text-danger pt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="col-lg-6 mt-3">
                                    ...
                                    <input type="text" name="code" class="form-control form--control" id="code" value="{{ old('code') }}">
                                    @error('code')
                                        <p class="text-danger pt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="col-lg-6 mt-3">
                                    ...
                                    <input type="text" name="symbol" class="form-control form--control" id="symbol" value="{{ old('symbol') }}">
                                    @error('symbol')
                                        <p class="text-danger pt-2">{{ $message }}</p>
                                    @enderror
                                </div>
