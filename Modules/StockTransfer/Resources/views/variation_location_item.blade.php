<tr>
    ...
    <td data-title="{{ __('unit_price') }}">
        <input type="text" class="form-control form--control " name="variation_locations[{{ $randomNumber }}][unit_price]" id="unit_price_{{$randomNumber}}" value="{{ old('unit_price',@$variation_location->ProductVariation->default_purchase_price) }}" />
    </td>  
...
@include('stocktransfer::variation_location_item_js')