                            ...
                            <div class="row mt-3"> 
                                ...
                                <div class="col-lg-6 mt-3">
                                    ...
                                    <select class="form-control form--control select2" name="variation_values[]" id="variation_values" multiple>
                                        @if(old('variation_values',$singleVariation->value) && !blank(old('variation_values',$singleVariation->value)))
                                ...
                                <div class="col-lg-12 mt-3">
                                    ...
                                    <textarea class="form-control form--control" name="description" id="description" placeholder="{{ __('enter_description') }}" rows="5">{{ old('description',$product->description) }}</textarea> 
                                    @error('description')
                                        <p class="text-danger pt-2">{{ $message }}</p>
                                    @enderror
                                </div>  
...
@endsection
@push('scripts')
<script src="{{ static_asset('backend') }}/js/product/edit.js"></script> 
@endpush