    ...
    <div class="row print-row">
        <div class="col-12 text-right mt-2">
            <div class="d-inline-block">
                <button type="button" class="btn btn-sm btn-primary text-white" onclick="window.print()">Print</button>
                <button type="button" class="btn btn-sm btn-danger text-white" onclick="window.close()">Close</button>
            </div>
        </div>
    </div>
    <div id="sale_print"> 
        <div class="row"> 
            <div class="col-12 mt-5"> 
                ...
                <div class="text-center"><small>( {{ __('sales') }} )</small></div>
                ...
                <tbody> 
                    ...
                    @foreach ($sale->saleItems as $item) 
                        <tr>  
                            ...
                            <td > 
                            <small>{{ businessCurrency($sale->business_id) }} {{ @$item->unit_price }}</small>
                            </td> 
                            <td > 
                            <small>{{ businessCurrency($sale->business_id) }}  {{ @$item->total_unit_price  }}</small>
                            </td> 
                        </tr>
                    @endforeach  
                </tbody>
