                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody id="sale_item_body"> 
                                                ...
                                                @foreach ($sale->saleItems as $item)
                                                    @include('sell::sale.variation_location_item_edit')
                                                @endforeach
                                            </tbody>
                                            <thead>
                                                <tr class="border-bottom bg-primary text-white head align-middle ">
                                            ...
                                            <div class="table-responsive  category-table product-view-table mt-3">
                                                <table class="table table-striped table-hover">
                                                    <thead>
                                                        ...
                                                        <input type="hidden" name="total_tax_amount" id="total_tax_amount" value="{{ $sale->total_tax_amount }}"/>
                                                        <input type="hidden" name="total_sell_price" id="total_sell_price" value="{{ $sale->total_sell_price }}"/>
