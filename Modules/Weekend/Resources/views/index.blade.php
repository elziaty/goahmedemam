...
@section('maincontent')
    ...
    <input type="hidden" id="get-weekends" data-url="{{ route('hrm.attendance.weekend.get.all') }}"/>
@endsection
@push('scripts') 
    <script src="{{ static_asset('backend') }}/js/bootstrap.bundle2.min.js" ></script>
    <script src="{{ static_asset('backend') }}/js/hrm/weekend_table.js" ></script>
@endpush
