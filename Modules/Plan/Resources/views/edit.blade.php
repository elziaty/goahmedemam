            ...
            <div class="row g-4">
                <div class="col-xl-12">
                    <div class="dashboard--widget ">
                        ...
                        <form action="{{ route('plans.update',['id'=>$plan->id]) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="row"> 
                                    <div class="col-lg-6 mt-3">
                                        <label for="name" class="form-label">{{ __('name') }} <span class="text-danger">*</span></label>
                                        <input type="text" name="name" class="form-control form--control" id="name" value="{{ old('name',@$plan->name) }}">
                                        @error('name')
                                    ...
                                    <div class="col-lg-6 mt-3">
                                        ...
                                        <input type="text" name="user_count" class="form-control form--control" id="user_count" value="{{ old('user_count',@$plan->user_count) }}">
                                        @error('user_count')
                                            <p class="text-danger pt-2">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    <div class="col-lg-6 mt-3">
                                        ...
                                        <input type="text" name="days_count" class="form-control form--control" id="days_count" value="{{ old('days_count',@$plan->days_count) }}">
                                        @error('days_count')
                                            <p class="text-danger pt-2">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    <div class="col-lg-6 mt-3">
                                        ...
                                        <input type="text" name="price" class="form-control form--control" id="price" value="{{ old('price',@$plan->price) }}">
                                        @error('price')
                                            <p class="text-danger pt-2">{{ $message }}</p>
                                        @enderror
                                    </div>
                                     ...
                                     <div class="col-lg-6 mt-3">
                                         ...
                                         <input  name="description" class="form-control form--control " id="description" value="{{ old('description',@$plan->description) }}" /> 
                                         @error('description')
                                             <p class="text-danger pt-2">{{ $message }}</p>
                                         @enderror
                                     </div>
                                     ...
                                     <div class="col-lg-3 mt-3">
                                        ...
                                        <input type="text" name="position" class="form-control form--control" id="position" value="{{ old('position',@$plan->position) }}">
                                        @error('position')
                                            <p class="text-danger pt-2">{{ $message }}</p>
                                        @enderror
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="d-flex mt-3">
                                                    ...
                                                    <input type="checkbox" class="status" id="status" switch="success" name="status" {{ old('status',@$plan->status) == \App\Enums\Status::INACTIVE? '':'checked' }} >
                                            ...
                                            @foreach ($modules as $module)                                                
                                                <div class="col-lg-2 col-md-4 col-sm-6">
                                                    <div class="d-flex align-items-center permission-check-box pb-2 pt-2"  >
                                                        <input id="{{ @$module }}"  class="read common-key" type="checkbox" value="{{ @$module }}" name="modules[]" @if(in_array($module,$plan->modules)) checked @endif  />
