...
<form action="{{ route('purchase.return.update.payment',['payment_id'=>$payment->id,'purchase_return_id'=>$payment->purchase_return_id]) }}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="row">   
