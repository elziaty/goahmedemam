                        ...
                        <form action="{{ route('accounts.expense.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mt-3">  
                                ...
                                <div class="col-md-6 mt-2">
                                    ...
                                    <input type="text" name="amount" class="form-control form--control" id="amount" value="{{ old('amount',0) }}">
                                    @error('amount')
                                        <p class="text-danger pt-2">{{ $message }}</p>
                                    @enderror
                                </div> 
...
@push('scripts')
<script src="{{ static_asset('backend') }}/js/expense/create.js" ></script> 
@endpush